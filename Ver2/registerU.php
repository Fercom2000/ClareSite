...
if ($conn->query($sql) === TRUE) {
	$key=generateKey(5);
	$sql2="INSERT INTO img (name,ext,location,description,type,val) VALUES (ENCODE('$pass','$key'),'jpg','./$key/','Default user image, do not delete or modify','System image: user','$user')";
